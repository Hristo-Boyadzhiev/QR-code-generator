...
## License
This project uses several libraries that are licensed under the MIT License, including Vite, React, qr-code-styling, React-hook-form, Yup,day.js dayjs-plugin-utc and dayjs-plugin-timezone. TypeScript is licensed under the Apache License 2.0. Montserrat is licensed under the SIL Open Font License, Version 1.1
