...
## License
This project uses several libraries that are licensed under the MIT License, including React, qrcode.react, React-hook-form, and Yup. Additionally, TypeScript is licensed under the Apache License 2.0.
